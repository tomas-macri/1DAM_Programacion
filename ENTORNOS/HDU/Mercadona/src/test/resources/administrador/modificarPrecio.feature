...
Feature: Como administrador quiero poder modificar el precio de un producto de la lista de productos
  Background:
    Given un usuario administrador
    When el usuario ingresa un 2
    #menu en el que elige entre agregar, modificar o eliminar

    And el usuario ingesa un 3
